...
impl LinkMessageBuilder<LinkBond> {
    ...
    pub fn use_carrier(self, use_carrier: bool) -> Self {
        self.append_info_data(InfoBond::UseCarrier(use_carrier.into()))
    }
    ...
    pub fn tlb_dynamic_lb(self, tlb_dynamic_lb: bool) -> Self {
        self.append_info_data(InfoBond::TlbDynamicLb(tlb_dynamic_lb.into()))
    }
    ...
    pub fn ad_lacp_active(self, ad_lacp_active: bool) -> Self {
        self.append_info_data(InfoBond::AdLacpActive(ad_lacp_active.into()))
    }
